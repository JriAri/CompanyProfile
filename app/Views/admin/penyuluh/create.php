        ...
        <div class="col-12">
            ...
            <div class="card shadow-sm">
                <div class="card-header">
                    <h5 class="mb-0">Tambah Penyuluh Baru</h5>
                </div>
                <div class="card-body">
                    <form action="<?= base_url('admin/penyuluh/simpan') ?>" method="post" enctype="multipart/form-data" id="formPenyuluh">
                        <?= csrf_field() ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select <?= session('errors.spesialisasi') ? 'is-invalid' : '' ?>" 
                                        ...
                                        <option value="pertanian" <?= old('spesialisasi') == 'pertanian' ? 'selected' : '' ?>>Pertanian</option>
                                        <option value="peternakan" <?= old('spesialisasi') == 'peternakan' ? 'selected' : '' ?>>Peternakan</option>
                                        <option value="perikanan" <?= old('spesialisasi') == 'perikanan' ? 'selected' : '' ?>>Perikanan</option>
                                        <option value="kehutanan" <?= old('spesialisasi') == 'kehutanan' ? 'selected' : '' ?>>Kehutanan</option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                    ...
                                    <select class="form-select <?= session('errors.wilayah_kerja') ? 'is-invalid' : '' ?>" 
                                        ...
                                        <?php foreach ($wilayahList as $kecamatan): ?>
                                            <option value="<?= esc($kecamatan) ?>" 
                                                <?= old('wilayah_kerja') == $kecamatan ? 'selected' : '' ?>>
                                                <?= esc($kecamatan) ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" 
                                           id="pengalaman" name="pengalaman" value="<?= old('pengalaman') ?>" min="0" step="1">
                                </div>
