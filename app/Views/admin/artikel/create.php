                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="ringkasan" name="ringkasan" rows="3" required><?= old('ringkasan') ?></textarea>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="penulis_id" name="penulis_id" required>
                                ...
                                <?php foreach ($penyuluhList as $penyuluh) : ?>
                                    <option value="<?= $penyuluh['id'] ?>" <?= old('penulis_id') == $penyuluh['id'] ? 'selected' : '' ?>>
                                        <?= $penyuluh['nama'] ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
